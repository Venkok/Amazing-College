...
class Admin {
	...
	public function render_submit_box() {
		...
		<div class="mbct-submit">
			<?php if ( $this->action() === 'edit' ) : ?>
				<a href="<?= esc_url( $delete_url ) ?>"><?php esc_html_e( 'Delete', 'mb-custom-table' ) ?></a>
			<?php endif ?>
	...
	public function enqueue() {
		if ( $this->is_screen_edit() ) {
			wp_enqueue_style( 'mbct-model-edit', MBCT_URL . 'assets/edit.css' );
			return;
		}

		wp_enqueue_style( 'mbct-list-table', MBCT_URL . 'assets/list-table.css' );
